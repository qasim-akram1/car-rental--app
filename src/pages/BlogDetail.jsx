          ...
          <Row>
            <Col lg="8" md="8">
              <div className="blog__details">
                ...
                <p className="section__description">{blog.content}</p> {/* Using a new field for actual content */}
              </div>
              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    ...
                    <p className="section__description">
                      Great insights on this topic! I learned a lot from your article and appreciate the detailed explanation.
                    </p>
                ...
                <div className="single__comment d-flex gap-3">
                  <img src={commentImg} alt="User Avatar" />
                  <div className="comment__content">
                    <h6 className="fw-bold">Emily Clarke</h6>
                    <p className="section__description mb-0">15 July, 2022</p>
                    <p className="section__description">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    ...
                    <p className="section__description">
                      I found this article very helpful. Keep up the great work!
                    </p>
              ...
              {blogData.map((item) => (
                <div className="recent__blog-post mb-4" key={item.id}>
                  <div className="recent__blog-item d-flex gap-3">
                    ...
                    </h6> {/* Fixed the link to point to the correct title */}
                  </div>
                </div>
              ))}
            </Col>
